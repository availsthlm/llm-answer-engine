...
export const config = {
    ...
    inferenceModel: "gpt-4-turbo-preview", // Groq: 'mixtral-8x7b-32768', 'gemma-7b-it' // OpenAI: 'gpt-3.5-turbo', 'gpt-4' // Ollama 'mistral', 'llama2' etc
    ...
    nonOllamaBaseURL: "https://api.openai.com/v1", //Groq: https://api.groq.com/openai/v1 // OpenAI:
