...
export const config = {
    ...
    inferenceModel: useGroq ? "mixtral-8x7b-32768" : "gpt-4-turbo-preview", // Groq: 'mixtral-8x7b-32768', 'gemma-7b-it' // OpenAI: 'gpt-3.5-turbo', 'gpt-4' // Ollama 'mistral', 'llama2' etc
    inferenceAPIKey: useGroq
        ? process.env.GROQ_API_KEY
        : process.env.OPENAI_API_KEY, // Groq: process.env.GROQ_API_KEY // OpenAI: process.env.OPENAI_API_KEY // Ollama: 'ollama' is the default
    ...
    nonOllamaBaseURL: useGroq
        ? "https://api.groq.com/openai/v1"
        : "https://api.openai.com/v1", //Groq: https://api.groq.com/openai/v1 // OpenAI:https://api.openai.com/v1
